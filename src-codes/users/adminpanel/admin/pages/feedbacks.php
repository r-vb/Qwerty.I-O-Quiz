                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th class="text-left pl-4" width="15%">Student Name</th>
                                <th class="text-left ">Ratings</th>
                                <th class="text-left ">Take-aways</th>
                                <th class="text-left ">Next Workshop</th>
                                <th class="text-left ">Improve QIO</th>
                                ...
                                if($selExam->rowCount() > 0)
                                {
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $selExamRow['fb_ratings']; ?></td>
                                            <td><?php echo $selExamRow['fb_mygains']; ?></td>
                                            <td><?php echo $selExamRow['fb_feedbacks']; ?></td>
                                            <td><?php echo $selExamRow['fb_improve']; ?></td>
