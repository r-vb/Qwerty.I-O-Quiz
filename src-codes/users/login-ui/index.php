...
<html lang="en">
<head>
	<title>QWERTYIO | Login</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="icon" type="image/x-icon" href="login-ui/images/favicon.ico">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(login-ui/images/favicon.ico);">
					<span class="login100-form-title-1">
						Qwerty.I/O<br><br>Exam Login
					</span>
				</div>
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn" align="right">
						...
						<!--<a href="https://www.sdmcetqwertyio.com" class="login100-form-btn">
							Back to Home
						</a>-->
					</div>
				</form>
