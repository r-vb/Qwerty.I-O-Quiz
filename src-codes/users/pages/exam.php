...
var warnings = 0; // Initialize the warning count
...
function logoutIfNotFullscreen() {
    if (!isFullscreen()) {
        ...
        addWarning(); // Increment the warning count
        alert("Warning: Do not exit full screen mode. You will be logged out at 4th warning! Warning count: " + warnings);
    }
}

setInterval(logoutIfNotFullscreen, 9000); // Check every 09 seconds (adjust as needed)
